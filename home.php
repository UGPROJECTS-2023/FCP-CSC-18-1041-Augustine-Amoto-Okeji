				...
				<div class="swiper-slide dark">
					<div class="container clearfix">
						<div class="slider-caption slider-caption-center">
							<h2 data-caption-animate="fadeInUp">FUD E-Learning Platform</h2>
				...
				<div class="swiper-slide dark" style="background-image: url('images/slider/Slide1.jpg'); background-position: center top;">
					<div class="container clearfix">
						<div class="slider-caption">
							<h2 data-caption-animate="fadeInUp">E-Learning</h2>
			...
			<div class="row clearfix">
				...
				<div class="col-lg-5">
					<div class="heading-block topmargin">
						<h1>FUD E-learning education <br>new way to learn</h1>
					</div>
					<p class="lead">FUD E-learning; our aim is to promote education. If you are a student, then contact us to secure your future. We deliver free international standard video lectures and content. We are also provide certificates in Web &amp; Software Development.</p>
				</div>
					...
					<div class="slider-wrap">
						<div class="slide">
							<div class="testi-image">
								<a href="#"><img src="images/fud_vc.jpg" alt="Customer Testimonails"></a>
							</div>
							<div class="testi-content">
								<p>We don&#39;t build services to make money&#59; we make money to build better services</p>
								<div class="testi-meta">
									Professor Abdulkarim Sabo Mohammed
						...
						<div class="slide">
							<div class="testi-image">
								<a href="#"><img src="fud_vc.jpg" alt="Customer Testimonails"></a>
							</div>
							<div class="testi-content">
